...
func TestEvalSpecialForms(t *testing.T) {
	tests := []struct {
		...
		{source: "(and)", want: true},
		{source: "(and true 1 \"ok\")", want: "ok"},
		{source: "(and true nil unknown-symbol)", want: nil},
		{source: "(and true false unknown-symbol)", want: false},
		{source: "(and true '() unknown-symbol)", want: []any{}},
		{source: "(or)", want: nil},
		{source: "(or nil false 0 \"ok\")", want: "ok"},
		{source: "(or nil false '())", want: nil},
		{source: "(or true unknown-symbol)", want: true},
		{source: "(or nil \"ok\" unknown-symbol)", want: "ok"},
